...
image::anim.gif[git-clone-animation, 600]

Click on "Clone Git Repository"

You will see the following at the top of your dev workspace:

image::git-url.png[clone-repo, 600]
...
Enter "/projects" in the "Choose a folder to clone \http://gitea.gitea.svc.cluster.local:3000/{{ USER_ID }}/workshop.git  into"

Click on "OK"

You will see the following message box:

image::git-workspace.png[git-workspace, 600]
