...
*Step 3.20:* Click on the "Topology" link on the left menu to view the deployed applications:
...
*Step 3.21:* You should be able to view the application landing page by clicking on the external link icon.
