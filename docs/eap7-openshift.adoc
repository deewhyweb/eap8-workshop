...
We've already deployed an instance of Red Hat SSO using the operator, this is configured and ready to use. Before we deploy the application to OpenShift we need to verify the Red Hat SSO configuration and push our changes to our individual gitea account.
