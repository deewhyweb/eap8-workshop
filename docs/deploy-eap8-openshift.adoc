...
*Step 1:* First step is to add the Red Hat plugin repositories for GA and early access software. Add this after the repositories tag
...
*Step 2:* Open the pom.xml file and add the following before the closing tag:
