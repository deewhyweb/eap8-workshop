...
*Step 4.16:* Next, we need to set the url of our Red Hat SSO application.  In the IDE, open the file: `coolstore/src/main/webapp/keycloak.json` and edit the contents so they look like the following:
